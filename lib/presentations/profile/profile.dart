...
class UserPreferences {
  static User myUser = User(
    ...
    name: 'Sarhbnm',
    email: 'sarah.abs@mvcxcvbnmgmail.com',
    about: 'fdfgvhbjnm',
    isDarkMode: true,
  );
  ...
  static void updateUser(User newUser) {
    myUser = newUser;
    // Optionally, save the updated user data to persistent storage here
  }
}
          ...
          Center(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: Color.fromARGB(255, 235, 163,
                      224), // Replace with your desired background color
                  boxShadow: [
                    BoxShadow(
  ...
  Widget buildUpgradeButton(BuildContext context) => ButtonWidget(
        ...
        onClicked: () {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    EditProfilePage()), // Replace EditProfilePage() with the page you want to navigate to
          );
        },
